...
{\small
Una introducción a los conceptos de la Estadística.}
}
\date{\small 2016.}
%pruebar
...
\small
\noindent \textbf{PostData 1.0. Una introducción a los conceptos de la Estadística. } \\
...
\noindent\includegraphics[width=2cm]{../exclude/Publicacion/Lulu/by-sa.png}\\
{%\scriptsize
\noindent
...
\noindent
{\bf Portada:} La fotografía de la portada muestra una colonia de Frailecillos ({\em Fratercula arctica}) en la isla de Horn{\o}ya (Noruega). Frailecillos, canguros y otras criaturas protagonizan algunos ejemplos del libro. La contraportada muestra una Malvasía Cabeciblanca ({\em Oxyura leucocephala}) en la Laguna de Los Charcones, en la localidad manchega de Miguel Esteban. La Malvasía Cabeciblanca acompaña desde sus orígenes al blog del que este libro toma el nombre. Ambas fotos fueron tomadas por Fernando San Segundo. \\
