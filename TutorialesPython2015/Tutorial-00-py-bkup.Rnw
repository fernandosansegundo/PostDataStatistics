        ...
        \begin{center}
            ...
            \begin{enumerate}
              \item Acostúmbrate a usar el botón derecho del ratón y busca opciones como {\tt
                  ...
                  hacer click o doble click con el botón izquierdo.
...
\begin{center}
\link{http://www.openoffice.org/download/other.html}{Todas las plataformas, fuentes, idiomas,
paquetes de idiomas}
\end{center}
...
Lo primero que debes saber es que las versiones 2 y 3 de Python no son compatibles al 100\%. Algunos programas escritos usando Python 2 no funcionarán con Python 3 y viceversa. Por esa razón la primera decisión que debemos tomar es cuál es la versión de Python que vamos a usar:
    ...
    \begin{center}
        \fcolorbox{black}{Gris025}{\begin{minipage}{11cm}
            {\sf En estos tutoriales vamos a usar siempre la versión 3 de Python.}
        \end{minipage}}
    \end{center}
...
\begin{center}
  \link{https://www.continuum.io/downloads}{https://www.continuum.io/downloads}
\end{center}
...
\begin{itemize}
  ...
  \item \ninja{Acude a tu ninja informático}. En particular, si tu profesor te ha pedido que leas este tutorial en algún curso universitario, pídele que te ayude con la instalación.  
\end{itemize}
...
%(\link{http://cran.es.r-project.org/}{cran.es.r-project.org}) suele funcionar bien. A partir de
...
%El principal requisito para ejecutar GeoGebra  es tener instalado Java. Puedes descargarte la última versión de Java (que, en el momento de escribir esto es la Version 7, Update 51), desde la página
%    \begin{center}
%    \link{http://www.java.com/}{www.java.com}
%    \end{center}
%En esa página encontrarás instrucciones detalladas de instalación, que dependen del sistema operativo de tu ordenador (Windows, Mac, Linux,...).  Tal vez no sepas si tienes Java ya instalado. En cualquier caso, siempre es una buena idea asegurarse de que la versión está actualizada (por razones de seguridad, entre otras). Puedes comprobarlo en este enlace:
%    \begin{center}
%    \link{http://www.java.com/es/download/installed.jsp}{www.java.com/es/download/installed.jsp}
%    \end{center}
%En lo que sigue, supondremos que tienes instalado Java.
