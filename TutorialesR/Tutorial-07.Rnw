...
<<t06ch09>>=
datos = scan(file = "../datos/Tut07-Contraste-Media-Z-datos.csv")
(n = length(datos))
(Xbar = mean(datos))
(s = sd(datos))
@
...
muestra = scan(file="../datos/Tut07-Contraste-Media-UsandoZ-datos.csv",sep=" ",dec=".")
mean(muestra)
...
<<>>=
muestra = scan(file="../datos/Tut07-Contraste-Varianza-datos.csv",sep=" ",dec=".")
...
<<t07ej08sol>>=
datos = scan(file = "../datos/Tut07-Ejercicio-ContrasteMedia.csv")
(n = length(datos))
(Xbar = mean(datos))
(s = sd(datos))
mu0 = 27
...
<<t07ej10sol>>=
datos = scan(file = "../datos/Tut07-Ejercicio-ContrasteVarianza.csv")
(n = length(datos))
