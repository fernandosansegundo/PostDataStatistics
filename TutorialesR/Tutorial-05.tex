...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in if (x > 4) \{: the condition has length > 1 and only the first element will be used}}\begin{verbatim}
## [1] 0
\end{verbatim}
\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in if ((x > 0) \& (x < 1)) \{: the condition has length > 1 and only the first element will be used}}\begin{verbatim}
## [1] 0
\end{verbatim}
\end{kframe}
\end{knitrout}
