...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in if (x > 4) \{: la condici'on tiene longitud > 1 y s'olo el primer elemento ser'a usado}}\begin{verbatim}
## [1] 0
\end{verbatim}
\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in if ((x > 0) \& (x < 1)) \{: la condici'on tiene longitud > 1 y s'olo el primer elemento ser'a usado}}\begin{verbatim}
## [1] 0
\end{verbatim}
\end{kframe}
\end{knitrout}
