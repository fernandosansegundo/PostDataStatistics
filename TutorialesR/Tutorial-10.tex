...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): no se pudo encontrar la funci'on "{}lmodel2"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): objeto 'lm2XY' no encontrado}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in abline(MinCuad\$Intercept, MinCuad\$Slope, col = "{}red"{}, lwd = 2, : objeto 'MinCuad' no encontrado}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in abline(MAR\$Intercept, MAR\$Slope, col = "{}darkgreen"{}, lwd = 2, : objeto 'MAR' no encontrado}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in abline(SMA\$Intercept, SMA\$Slope, col = "{}blue"{}, lwd = 2, lty = 2): objeto 'SMA' no encontrado}}\begin{alltt}
