...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in pacientesPorGenero\textasciicircum{}2: argumento no-numérico para operador binario}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in labels(estadoCarreteras) = c("{}atasco"{}, "{}moderado"{}, "{}fluido"{}): no se pudo encontrar la función "{}labels<-"{}}}\end{kframe}
\end{knitrout}
...
\end{verbatim}
\begin{alltt}
\hlcom{# Proporcion muestral (¡es una fraccion! Numero de exitos/n)}
